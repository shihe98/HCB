...
def get_clean_test():
    ...
    test_label = np.load('./data/testLab.npy')
...
def get_backdoor_test():
    rain_imgs = np.load('./data/rain_test.npy')
    rain_labs = np.load('./data/rainLab_test.npy')
    for i in range(len(rain_imgs)):
...
def get_fpr_nes_test():
    rain_imgs = np.load('./data/test.npy')
    rain_labs = np.load('./data/testLab.npy')
    test_data=None
    for i in range(len(rain_imgs)):
        if rain_labs[i] !=0:
